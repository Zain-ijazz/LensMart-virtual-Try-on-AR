...
export default () => {
  ...
  return (
      <footer className="text-[#a7a9be] bg-[#0f0e17] px-8 py-6 w-full mx-auto md:px-8">
          <div className="gap-6 justify-between md:flex">
              <div className="flex-1">
                  <div className="max-w-xs">
                  <div className="navbar1-logo">
          <Link to="/" className='hind-madurai-medium'>Lens Mart</Link>
        </div>
                      <p className="leading-relaxed mt-2 text-[15px]">
                      Join our community today and step into a world of effortless eyewear shopping.
                      </p>
                  </div>
                  <form 
                  ...
                  >
                      ...
                      <div className="max-w-sm flex items-center border rounded-md p-1">
                          ...
                          />
                          <button
                              className="p-2.5 rounded-md text-[#fffffe] bg-[#ff8906] outline-none shadow-md focus:shadow-none sm:px-5 hover:text-[#fffffe] hover:bg-orange-600"
                          >
                              Subscribe
                          </button>
                      </div>
              ...
              <div className="flex-1 mt-10 space-y-6 items-center justify-between sm:flex md:space-y-0 md:mt-0">
                  {
                      footerNavs.map((item, idx) => (
                          <ul
                              ...
                              key={idx}
                          >
                              <h4 className="text-[#fffffe] font-medium">
                                  { item.label }
                              </h4>
                              {
                                  item.items.map(((el, idx) => (
                                      <li key={idx}>
                                          <a 
                                              href={el.href}
                                              className="hover:underline hover:text-[#ff8906]"
          ...
          <div className="mt-8 py-6 border-t items-center justify-between sm:flex">
              <div className="mt-4 sm:mt-0">
                  &copy; 2024 Lens Mart. All rights reserved.
              </div>
